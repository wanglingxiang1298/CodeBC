...
interface IERC1820Registry {
    ...
    function updateERC165Cache(address _target, bytes4 _interfaceHash, bool _implemented) external;
    ...
    event ManagerChanged(address indexed _target, address indexed _newManager);
}
