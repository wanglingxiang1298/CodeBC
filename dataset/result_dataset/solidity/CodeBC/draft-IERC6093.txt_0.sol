...
interface IERC721Errors {
    ...
    event ERC721ApprovalFailed(address token, Error err, address msgSender, address account);
}
interface IERC1155Errors {
    ...
    event ERC1155ApprovalFailed(address token, Error err, address msgSender, address account);
}
