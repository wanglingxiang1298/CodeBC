...
interface IERC1155Errors {
    ...
    function safeTransferFrom(address token, address from, address to, uint256 id, uint256 amount) external;
    function safeBatchTransferFrom(address token, address from, address to, uint256[] calldata ids, uint256[] calldata amounts) external;
}