...
interface ICompoundTimelock {
    ...
    function queuedTransactions(uint256 transactionId) public view returns (bytes memory);
    function setDelay(uint256 delay_) public;
    function acceptAdmin() public;
    function setPendingAdmin(address pendingAdmin_) public;
    function queueTransaction(uint256 transactionId, bytes memory data) public;
