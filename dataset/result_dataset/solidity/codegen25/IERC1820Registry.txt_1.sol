...
interface IERC1820Registry {
    ...
    function implementsERC165Interface(address _address, bytes4 _msg) external view returns (bool);
    function implementsERC165InterfaceNoCache(address _address, bytes4 _msg) external view returns (bool);
    event InterfaceImplementerSet(address indexed _implementer, bytes32 indexed _interfaceId);
